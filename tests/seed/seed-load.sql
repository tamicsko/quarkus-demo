...
VALUES
  ('c1b2c3d4-3333-4000-8000-000000000001', 'd1d2d3d4-4444-4000-8000-000000000001', 'b1b2c3d4-2222-4000-8000-000000000001', 'b1b2c3d4-2222-4000-8000-000000000003', 25000.00, 'HUF', 'COMPLETED', NOW(), NOW()),
  ('c1b2c3d4-3333-4000-8000-000000000002', 'd1d2d3d4-4444-4000-8000-000000000002', 'b1b2c3d4-2222-4000-8000-000000000004', 'b1b2c3d4-2222-4000-8000-000000000002',   100.00, 'EUR', 'COMPLETED', NOW(), NOW()),
  ('c1b2c3d4-3333-4000-8000-000000000003', 'd1d2d3d4-4444-4000-8000-000000000003', 'b1b2c3d4-2222-4000-8000-000000000005', 'b1b2c3d4-2222-4000-8000-000000000007', 50000.00, 'HUF', 'COMPLETED', NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
