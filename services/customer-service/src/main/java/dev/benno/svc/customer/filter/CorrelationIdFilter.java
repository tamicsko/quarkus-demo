package dev.benno.svc.customer.filter;
...
/**
 * Correlation ID kezelés bejövő kérésekhez.
 *
 * Ha a hívó küld X-Correlation-ID header-t → használjuk azt.
 * Ha nem → generálunk egyet.
 * Az ID bekerül az MDC-be (logoláshoz) és a válasz header-be is.
 */
@Provider
