...
public interface AccountServiceClient {
    ...
    BalanceDto creditAccount(@PathParam("id") String id, BalanceOperationRequest request);

    @POST
    @Path("/{id}/balance/debit")
    BalanceDto debitAccount(@PathParam("id") String id, BalanceOperationRequest request);
